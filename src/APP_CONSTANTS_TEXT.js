...
export const PLATFORM_TEMP1 = `Omnichannel Apply`;
export const PLATFORM_TEMPBODY1 = `    Deliver tailored white-labeled consumer experiences, designed
                  and optimized for conversions across all channels.`;
export const PLATFORM_TEMP2 = `Design Engine`;
